    ...
    schema_str= """
{
  ...
  "type": "object"
    ...
    """
    jsondeserializer = JSONDeserializer(schema_str,from_dict=Car.dict_to_car)
    ...
    while True:
        try:
            ...
            if msg is None:
                continue
            car = jsondeserializer(msg.value(),SerializationContext(msg.topic(),MessageField.VALUE))
            if car is not None:
